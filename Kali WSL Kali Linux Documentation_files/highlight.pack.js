...
literal:["true","false"],
built_in:["7z","[","]","adduser","alias","amixer","apropos","apt","apt-btrfs-snapshot","apt-cache","apt-cdrom","apt-get","arch","autoload","autopkgtest-build-qemu","b2sum","base32","base64","basename","bg","bind","bindkey","break","btrfs","builtin","bye","bzip2","caller","cap","cat","cd","cgpt","chcon","chdir","chgrp","chmod","chown","chroot","cksum","clinfo","clone","comm","command","comparguments","compcall","compctl","compdescribe","compfiles","compgroups","compquote","comptags","comptry","compvalues","continue","cp","crontab","cryptsetup","csplit","curl","cut","date","dd","debi","debootstrap","declare","deluser","df","dh_make","diff","dir","dircolors","dirname","dirs","disable","diskutil","disown","docker","dpkg","dpkg-buildpackage","dpkg-checkbuilddeps","dpkg-reconfigure","du","e2label","echo","echotc","echoti","emulate","enable","env","eval","exec","exit","expand","export","expr","factor","fc","fdisk","fg","file","finalrecon","find","flatpak","float","fmt","fold","free","functions","gbp","gdisk","getcap","getln","getopts","git","glxinfo","gpg","grep","groups","hash","hashcat","head","help","history","hostid","id","instaloader","integer","jobs","join","js-beautify","kaboxer","kali-arm-build-scripts/rpi.sh","kali-tweaks","kali-undercover","kernel_data_key.vbprivk","kill","kpartx","lb","let","limit","link","ln","local","log","logname","logout","losetup","ls","lsb_release","lsinitramfs","lsmod","lspci","lxc","lxc-attach","lxc-console","lxc-create","lxc-start","lxd","make","man","mapfile","md5sum","mkdir","mkfifo","mkfs.ext2","mkfs.ext3","mkfs.ext4","mkfs.vfat","mkimage","mkinitramfs","mknod","mktemp","mount","mount-shared-folders","msfconsole","msfdb","mv","netstat","nice","nl","noglob","nohup","nproc","numfmt","nvidia-detect","nvidia-smi","nvidia-xconfig","od","openssl","ovftool","parted","partprobe","passwd","paste","patch","pathchk","pcsc_scan","pinky","pip3","pkg","popd","poweroff","pr","print","printenv","printf","ptx","pushd","pushln","pwd","pyenv","python","python3","qemu-img","qemu-system-x86_64","read","readarray","readlink","readonly","realpath","reboot","rehash","restart-vm-tools","return","rm","rmdir","rsync","runcon","sbuild-adduser","sbuild-createchroot","sbuild-shell","sched","screen","sed","seq","service","set","setcap","setopt","sh","sha1sum","sha224sum","sha256sum","sha384sum","sha512sum","shasum","shift","shopt","shred","shuf","sleep","snap","sort","source","split","ss","ssh","ssh-keygen","stat","stdbuf","stty","su","sudo","sum","suspend","sync","sysctl","systemctl","tac","tail","tar","tee","termux-setup-storage","test","time","timedatectl","timeout","times","torbrowser-launcher","touch","tr","trap","truncate","tsort","tty","ttyctl","type","typeset","ulimit","umask","umount","unalias","uname","unexpand","unfunction","unhash","uniq","unlimit","unlink","unset","unsetopt","unzip","update-alternatives","update-initramfs","uptime","uscan","useradd","usermod","users","vared","vbutil_kernel","vdir","vim","virsh","virtualbox","vmware","vmware-modconfig","vncserver","wait","wc","wget","whence","where","which","who","whoami","x11vnc","xc","xdpyinfo","xfce4-session-logout","xfconf-query","xrandr","xrdb","xzcat","yes","ykpersonalize","zcompile","zformat","zftp","zle","zmodload","zparseopts","zprof","zpty","zregexparse","zsocket","zstyle","ztcp"]
